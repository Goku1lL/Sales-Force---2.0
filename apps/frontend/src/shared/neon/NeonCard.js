...
export function NeonCard(props) {
    ...
    return (_jsxs("div", { className: [
            ...
            hoverEffects,
            props.className
        ].join(' '), children: [_jsx("div", { className: "absolute inset-0 rounded-2xl pointer-events-none", style: { boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.04)' } }), props.children] }));
}
